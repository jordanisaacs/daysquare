{
  ...
  outputs = { self, nixpkgs, utils, naersk, rust-overlay, sops-nix, mongofix, ... }:
    let
      ...
      redact_db_host_addr = "10.250.0.1";
      redact_db_user = "daysquare";
      redact_db_password = "daysquare";
      redact_db_port = 4242;
      redact_db_name = "daysquare";
      redact_db_container_name = "redactDB";
      redact_db_conn_string = "mongodb://${redact_db_user}:${redact_db_password}@${redact_db_container_name}:${builtins.toString redact_db_port}/${redact_db_name}";
        ...
        ''
          {
            ...
            containers."${redact_db_container_name}" = {
              ephemeral = true;
              privateNetwork = true;
              hostAddress = \"${redact_db_host_addr}\";
    ...
    rec {
      devShell."${system}" = pkgs.mkShell {
        ...
        #REDACT_DB_URL = "mongodb://${redact_db_user}:${redact_db_password}@${redact_db_container_name}:${builtins.toString redact_db_port}/${redact_db_name}";
        #REDACT_DB_URL = "mongodb://root:${redact_db_root_password}@${redact_db_container_name}:${builtins.toString redact_db_port}";
